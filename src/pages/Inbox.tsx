...
const DEFAULT_MESSAGES: ContactMessage[] = [
  {
    ...
    message: "Selamat pagi, saya ingin menanyakan jadwal pendaftaran siswa baru untuk tahun ajaran 2026/2027. Kapan pendaftaran dibuka?",
    isRead: false,
  ...
  },
  {
    ...
    phone: "",
    subject: "Kerja Sama",
    message: "Kami dari lembaga pendidikan ingin menjajaki kerja sama program pertukaran pelajar dengan sekolah Bapak/Ibu.",
    isRead: false,
